...
import ResetPasswordWithToken from "../auth/resetPassword/resetPasswordWithToken";
...
import Communication from "../academic/communication"
...
import AddAttendance from "../peoples/students/student-details/AddAttendance";
...
import TeacherTimeTable from "../peoples/teacher/teacher-details/teacherTimeTable";
import AddTimeTable from "../academic/add-timetable";
...
import SuperAdminDashboard from "../mainMenu/superAdminDashboard/index.tsx";
import StudentViewProgress from "../peoples/students/student-details/studentViewProgress.tsx";
import StudentLogMemorization from "../peoples/students/student-details/studentLogMemorization.tsx";
import StudentStartRecitation from "../peoples/students/student-details/studentStartRecitation.tsx";
import Home from "../auth/website/home.tsx";
import Pricing from "../auth/website/pricing.tsx";
import Register from "../auth/website/register.tsx";
import RegisterSuccess from "../auth/website/register-success.tsx";
import SuperAdminLogin from "../auth/login/login-4.tsx";
import AdminStudentList from "../peoples/superadmin/student-list/index.tsx";
import AdminSchoolList from "../peoples/superadmin/school-list/index.tsx";
import AdminTeacherList from "../peoples/superadmin/teacher-list/index.tsx";
import StudentCommunication from "../academic/student-communication/index.tsx";
import SchoolProfile from "../pages/schoolProfile/index.tsx";
...
export const publicRoutes = [
  ...
  {
    path: routes.adminStudentList,
    element: <AdminStudentList />,
    route: Route,
  },

  {
    path: routes.adminSchoolList,
    element: <AdminSchoolList />,
    route: Route,
  },

  {
    path: routes.adminTeacherList,
  ...
  {
    path: routes.studentViewProgress,
    element: <StudentViewProgress />,
       route: Route,
  },

  {
    path: routes.studentLogMemorization,
    element: <StudentLogMemorization />,
       route: Route,
  },

  {
    path: routes.studentStartRecitation,
    element: <StudentStartRecitation />,
       route: Route,
  },
  ...
  {
    path: routes.studentcommunication,
