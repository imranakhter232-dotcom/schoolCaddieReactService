          ...
          <div className="row">
            ...
            <div className="col-xxl-9 col-xl-8">
              <div className="row">
                ...
                <li>
                  <Link to={routes.studentStartRecitation} className="nav-link">
                ...
                <li>
                  <Link to={routes.studentLogMemorization} className="nav-link">
                ...
                <li>
                  <Link to={routes.studentViewProgress} className="nav-link">
                    <i className="ti ti-books me-2" />
                    View Progress
                  </Link>
                </li>
