...
import { feeGroup, feesTypes, leaveType, paymentType, surahsRecited, juzzRecited, qualityAssessment  } from '../../../core/common/selectoption/selectoption'
...
<>
  ...
  {/* Add Log Recitation */}
  <div className="modal fade" id="add_log_recitation">
    <div className="modal-dialog modal-dialog-centered  modal-lg">
      <div className="modal-content">
        <div className="modal-header">
          <div className="d-flex align-items-center">
            <h4 className="modal-title">Add Log Recitation</h4>
            {/* <span className="badge badge-sm bg-primary ms-2">AD124556</span> */}
          </div>
          <button
            type="button"
        ...
        <form>
  <div id="modal-datepicker" className="modal-body">
    {/* ------ student header (kept exactly as original) ------ */}
    

    {/* ------ form fields (all follow Payment Type pattern) ------ */}
    <div className="row">
      ...
      <div className="col-lg-12">
  <div className="mb-3">
    <label className="form-label">Surahs Recited</label>
    <CommonSelect
      className="select"
      options={surahsRecited}
      defaultValue={surahsRecited[0]}
    />
  </div>
</div>
...
<div className="col-lg-12">
  <div className="mb-3">
    <label className="form-label">Juzz Recited</label>
    <CommonSelect
      className="select"
      options={juzzRecited}
      defaultValue={juzzRecited[0]}
    />
  </div>
</div>
...
<div className="col-lg-12">
  <div className="mb-3">
    <label className="form-label">Quality Assessment</label>
    <CommonSelect
      className="select"
      options={qualityAssessment}
      defaultValue={qualityAssessment[0]}
    />
  </div>
</div>
