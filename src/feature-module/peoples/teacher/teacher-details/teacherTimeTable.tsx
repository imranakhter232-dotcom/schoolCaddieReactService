...
import { getTeacherTimeTable } from "../../../../core/api/timetableService";
                ...
                <div className="col-md-12">
                  ...
                  <ul className="nav nav-tabs nav-tabs-bottom mb-4">
                    <li>
                      <Link to={routes.teacherDetails} className="nav-link">
                        <i className="ti ti-school me-2" />Teacher Details
                      </Link>
                    </li>
                    {/* <li>
                    ...
                    <li>
                      <Link to={routes.teacherTimeTable} className="nav-link active">
                        <i className="ti ti-calendar-time me-2" />Time Table
                      </Link>
                    </li>
                    <li>
                  ...
                  <div className="card">
                    <div className="card-header">
                      <h4 className="mb-0">My Time Table</h4>
                    </div>
                    <div className="card-body pb-0">
                      {loading ? (
                        ...
                        <div className="text-center py-4 text-muted">No timetable assigned.</div>
                      ) : (
                            ...
                            <div key={day} className="d-flex flex-column me-4 flex-fill">
                              ...
                              {grouped[day].map((item: any, idx: number) => (
                                ...
                                >
                                  ...
                                  {item.class_name && (
                                    <p className="text-muted mb-0 small">Class : {item.class_name}</p>
                                  )}
                                </div>
                              ))}
                            </div>
