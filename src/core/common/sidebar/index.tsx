...
const Sidebar = () => {
  ...
  const [schoolName, setSchoolName] = useState("Welcome");
  const [sidebarItems, setSidebarItems] = useState(() => getSidebarData());

  // Re-compute sidebar whenever role_id changes (e.g. right after login)
  useEffect(() => {
    setSidebarItems(getSidebarData());
  }, [Location.pathname]);
      ...
      >
        ...
        <div className="sidebar-bottom">
          <button 
            ...
            className="btn btn-logout w-100 d-flex align-items-center justify-content-center"
          >
