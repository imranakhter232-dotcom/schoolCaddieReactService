...
export const moreFilterBookIssue = [
  { value: 'ID', label: 'ID' },
...
export const surahsRecited = [
  { value: "Surah Al-Fatiha", label: "Surah Al-Fatiha" },
  { value: "Surah Al-Baqarah", label: "Surah Al-Baqarah" },
  { value: "Surah Al-Ikhlas", label: "Surah Al-Ikhlas" },
];

export const juzzRecited = [
  { value: "Juzz 1", label: "Juzz 1" },
  { value: "Juzz 2", label: "Juzz 2" },
  { value: "Juzz 3", label: "Juzz 3" },
];
